...
//                     routeId: route.id,
//                     clientId: user.id,
//                     driverId: route.driverId // Include driverId in the request
//                 }),
//             });
...
//             <p><strong>Driver ID:</strong> {route.driverId}</p> {/* Display the driverId */}
...
//                     center={{ lat: 6.9271, lng: 79.8612 }} // Example center (Colombo, Sri Lanka)
//                     zoom={10}
//                 >
    ...
    const handleBooking = async () => {
        ...
        try {
            const response = await fetch('http://localhost:5000/api/bookings', {
                ...
                body: JSON.stringify({
                    routeId: route.id,
                    clientId: user.clientId || user.id,  // Ensure clientId is correctly passed
